...
int expected_conflicts;		/* expected number of shift/reduce conflicts */
...
get_tag(void)
{
	...
	tagmax += 16;
	tag_table = (char **)
	    (tag_table ? erealloc(tag_table, tagmax * sizeof(char *))
	     : emalloc(tagmax * sizeof(char *)));
    }
...
initialize_grammar(void)
{
    nitems = 4;
    maxitems = 300;
    pitem = (bucket **) emalloc(maxitems * sizeof(bucket *));
    pitem[0] = 0;
    pitem[1] = 0;
    pitem[2] = 0;
    pitem[3] = 0;
    ...
    nrules = 3;
    maxrules = 100;
    plhs = (bucket **) emalloc(maxrules * sizeof(bucket *));
    plhs[0] = 0;
    plhs[1] = 0;
    plhs[2] = 0;
    rprec = (short *) emalloc(maxrules * sizeof(short));
    rprec[0] = 0;
    rprec[1] = 0;
    rprec[2] = 0;
    rassoc = (char *) emalloc(maxrules * sizeof(char));
    rassoc[0] = TOKEN;
    rassoc[1] = TOKEN;
    rassoc[2] = TOKEN;
}
...
{
    maxitems += 300;
    pitem = (bucket **) erealloc(pitem, maxitems * sizeof(bucket *));
}
...
{
    maxrules += 100;
    plhs = (bucket **) erealloc(plhs, maxrules * sizeof(bucket *));
    rprec = (short *) erealloc(rprec, maxrules * sizeof(short));
    rassoc = (char *) erealloc(rassoc, maxrules * sizeof(char));
}
...
pack_names(void)
{
    ...
    name_pool_size = 13;		/* 13 == sizeof("$end") +
					 * sizeof("$accept") */
...
pack_symbols(void)
{
    ...
    symbol_name = (char **) emalloc(nsyms * sizeof(char *));
    symbol_value = (short *) emalloc(nsyms * sizeof(short));
    symbol_prec = (short *) emalloc(nsyms * sizeof(short));
    symbol_assoc = emalloc(nsyms);

    v = (bucket **) emalloc(nsyms * sizeof(bucket *));
...
pack_grammar(void)
{
    ...
    ritem = (short *) emalloc(nitems * sizeof(short));
    rlhs = (short *) emalloc(nrules * sizeof(short));
    rrhs = (short *) emalloc((nrules + 1) * sizeof(short));
    rprec = (short *) erealloc(rprec, nrules * sizeof(short));
    rassoc = erealloc(rassoc, nrules);
